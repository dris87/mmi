...
$(document).ready(function () {
    ...
    $('#btnEducationCancel').on('click', function () {
        $('#degreeLevelId').val('');
        $('#degreeLevelId').
            select2({ 'width': '100%', 'placeholder': 'Válasszon végzettségi szintet' });
        hideAddEducationDiv();
    });
...
window.showAddEducationDiv = function () {
    ...
    $('#educationCityId').
        select2({ 'width': '100%', 'placeholder': 'Válasszon települést' });
...
window.showAddExperienceDiv = function () {
    ...
    $('#cityId').select2({ 'width': '100%', 'placeholder': 'Válasszon települést' });
