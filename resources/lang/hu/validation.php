...
return [
    ...
    'url'                  => 'A(z) :attribute érvénytelen link, a mezőnek tartalmaznia kell a protokolt (https://).',
    ...
    'array_min_one_item_required' => 'A(z) :attribute minimum 1 elemet kell, hogy tartalmazzon.',
    'attributes' => [
        ...
        'iso_code'  => 'iso kód',
        'language'  => 'nyelv',
        'degree_level_id'=> 'Végzettég szintje',
        ...
        'job_title'              => 'hirdetés címe',
        'job_position'              => 'pozíció megnevezése',
        'job_shifts'              => 'beosztás',
        'job_locations'           => 'munkavégzés helye',
        'job_candidate_count'    => 'keresett fő',
        'job_types'            => 'alkalmazási forma',
        'job_categories'        => 'kategória',
        'description'            => 'rövid leírás',
        'tasks'                  => 'feladatok',
        'advantages'             => 'előnyök',
        'job_release_date'        => 'hirdetés megjelenésének dátuma',
        'job_expiry_date'       => 'jelentkezési határidő',
        'jobRequirements'        => 'elvárások',
        'jobRequirements.drivers_license.*.drivers_license_name' => 'jogosítvány',
        'jobRequirements.education.*.education_name' => 'végzettség megnevezése',
        'jobRequirements.education.*.education_level' => 'végzettség szintje',
        'jobRequirements.experience.*.experience_position' => 'betöltött pozíció',
        'jobRequirements.experience.*.experience_years' => 'tapasztalat évben',
        'jobRequirements.personal_skill.*.personal_skill_name' => 'személyes kompetencia',
        'jobRequirements.software_skill.*.software_skill_name' => 'szoftverismeret',
        'jobRequirements.software_skill.*.software_skill_level' => 'szoftverismeret szintje',
        'jobRequirements.it_skill.*.it_skill_name' => 'it szakismeret',
        'jobRequirements.it_skill.*.it_skill_level' => 'it szakismeret szintje',
        'jobRequirements.language_skill.*.language_skill_name' => 'nyelvismeret',
        'jobRequirements.language_skill.*.language_skill_level' => 'nyelvismeret szintje',
        'street' => 'utca',
        'able_to_travel_distance'=>'utázasi hajlandóság',
        'expected_salary'=>'Bérigény -tól',
        'expected_salary_to'=>'Bérigény -ig',
        'resumes' => 'önéletrajz',
        'industry_id' => 'iparág',
        'established_in' => 'alapítási év',
        'company_size' => 'alkalmazottak száma',
        'representative' => 'cégképviseletre jogosult személy neve',
        'companySites.*.zip_code' => 'irányítószám',
        'companySites.*.city' => 'város',
        'companySites.*.address' => 'házszám',
        'companySites.*.street' => 'utca',
        'companySites.*.floor' => 'emelet',
        'companySites.*.door' => 'ajtó',
        'introduction'  => 'bemutatkozás',
        'mission'   => 'misszió',
        'why_work_with_us'  => 'miért nálunk',
        'companyAwards.*.name' => 'megnevezés',
        'companyAwards.*.description' => 'leírás',
        'companyAwards.*.award_image' => 'kép a díjról',

        'mailing_zipCode' => 'mailing irányítószám',
        'mailing_city'    => 'város',
        'mailing_houseNumber'    => 'házszám',
        'mailing_street'    => 'utca',
        'mailing_floor'    => 'emelet',
        'mailing_door'    => 'ajtó',
        ...
        'branch_office_id' => 'kirendeltség',
        'superior_id' => 'felettes',
        'main_permission_id' => 'jogosultsági kör',
        'extra_permission_ids' => 'extra jogosultság',
        'new_password' => 'jelszó',
        'new_password_confirmation' => 'jelszó megerősítése',
        'diff_mailing_address' => 'eltérő levelezési cím megadása',
