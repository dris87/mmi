...
@endpush
@section('content')
    <section class="section profile position-static">
        <div class="section-header">
            <h1>{{ $company->name }} profilja</h1>
            <a class="font-weight-bold public-profile"
               href="{{ route('company.index') }}">{{ __('messages.common.back') }}</a>
        </div>
        ...
        <div class="section-body">
            <div>
                ...
                <div class="py-0 mt-2">
                    @include('companies.profile_menu')
                </div>
            </div>
    ...
    @include('companies.profile.modals.applicants_resumes')
@endsection
@push('scripts')
    <script>
