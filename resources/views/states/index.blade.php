        ...
        <div class="section-header flex-wrap">
            ...
            <div class="section-header-breadcrumb">
                <div class="px-3 grid-flex-end">
                    {{ Form::select('country', $countries, null, ['id' => 'filter_country', 'class' => 'form-control status-filter w-100', 'placeholder' => 'Válasszon országot']) }}
                </div>
...
@push('scripts')
    ...
    <script src="{{asset('assets/js/states/states.js')}}"></script>
@endpush
