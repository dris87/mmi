...
@section('section')
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-6">
            ...
            {{ Form::select('country_id', $data['countries'], !empty($user->country_id) ? $user->candidate->country_name : null, ['id'=>'countryId','class' => 'form-control','placeholder' => 'Válasszon országot']) }}
        </div>
        <div class="form-group col-sm-6">
        ...
        <div class="form-group col-sm-6">
            ...
            {{ Form::select('city_id', (isset($cities) && $cities!=null?$cities:[]), isset($user->city_id) ? $user->city_name : null, ['id'=>'cityId','class' => 'form-control','placeholder' => 'Válasszon települést']) }}
        </div>
        <div class="form-group col-sm-6">
