...
@push('page-scripts')
    <script>
        ...
        let candidateProfileUrl = "/edit-profile/<?=$candidate->id?>";
        ...
        let customCssUrl = "{{ asset('assets/css/custom.css?v=5.0.0') }}";
        let styleCssUrl = "{{ asset('web/backend/css/style.css?v=5.0.0') }}";
