...
<div class="row">
    ...
    <div class="form-group col-sm-12">
        {{ Form::label('country', __('messages.company.country').':') }}<span
                class="text-danger">*</span>
        {{ Form::select('country_id', $data['countries'], null, ['id'=>'candidateCountryId','class' => 'form-control','placeholder' => 'Válasszon országot','required']) }}
    </div>
    <div class="form-group col-sm-12">
    ...
    <div class="form-group col-sm-12">
        ...
        {{ Form::select('city_id', [], null, ['id'=>'candidateCityId','class' => 'form-control','placeholder' => 'Válasszon települést']) }}
    </div>
</div>
<div class="text-right">
    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary','id'=>'btnEditGeneralSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.processing')]) }}
