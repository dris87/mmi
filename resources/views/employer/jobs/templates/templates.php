<script id="jobActionTemplate" type="text/x-jsrender">
   {{if editable}}
<!--            <a title="--><?php //echo __('messages.job_applications') ?><!--" class="btn btn-dark  mb-1 mt-1" href="{{:jobApplicationUrl}}" data-toggle="tooltip" data-placement="bottom">-->
<!--                    <i class="fa fa-users"></i>-->
<!--            </a>-->
       <a title="<?php echo __('messages.common.details') ?>" class="btn mt-1 mb-1 btn-warning " href="{{:url}}" data-toggle="tooltip" data-placement="bottom">
            <i class="fa fa-edit"></i>
       </a>
   {{/if}}
   <a title="Hírdetés megtekintése" class="btn mt-1 mb-1 btn-success copy-btn" data-job-id="{{:jobId}}" target="_blank" href="{{:frontJobDetail}}/{{:job_id}}" data-toggle="tooltip" data-placement="bottom">
        <i class="fa fa-eye"></i>
   </a>
   <a title="<?php echo __('messages.common.delete') ?>" class="btn mt-1 mb-1 btn-danger  delete-btn" data-id="{{:id}}" href="#" data-toggle="tooltip" data-placement="bottom">
        <i class="fa fa-trash"></i>
   </a>
</script>

<script id="jobStatusActionTemplate" type="text/x-jsrender"> 111111 {{status}}
{{if !isJobClosed}}
 {{if status == 'Drafted' || status == 'Admin_declined'}}
