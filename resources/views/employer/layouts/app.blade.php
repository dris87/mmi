...
<!-- Template CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('css/custom.css?v=5.0.0') }}">
...
<script src="{{ asset('web_front/js/mumi.js') }}"></script>
...
<script src="{{ asset('assets/js/employer_profile/employer_profile.js') }}"></script>
