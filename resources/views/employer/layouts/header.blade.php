        ...
        @if(\Illuminate\Support\Facades\Auth::user())
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-drp">
                    ...
                    <a class="dropdown-item has-icon __editProfileModal__" href="#" data-id="{{ getLoggedInUserId() }}">
...
<nav class="navbar navbar-secondary navbar-expand-lg">
    <div class="container">
        <ul class="navbar-nav">
            <li class="nav-item {{ Request::is('cegfiok*') ? 'active' : ''}}">
                <a href="{{ route('employer.dashboard') }}" class="nav-link"><i
                            class="fab fa-dashcube"></i><span>{{ __('messages.dashboard') }}</span></a>
            </li>
                <li class="nav-item dropdown {{ Request::is('employer/company*') ? 'active' : ''}}">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"
                   href="##">
                    <i class="far fa-user-circle"></i>
                    <span>{{ __('messages.employer_menu.company_information') }} </span>
                </a>
                <ul class="dropdown-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('company.edit.form', \Illuminate\Support\Facades\Auth::user()->owner_id) }}">{{ __('messages.employer_menu.company_profile') }}</a>
{{--                        <a class="nav-link" href="##">{{ __('messages.employer_menu.company_profile') }}</a>--}}
{{--                        {{ route('company.coworkers.list')}}--}}
                        <a class="nav-link" href="##">{{ __('messages.employer_menu.company_coworkers') }}</a>
                        <a class="nav-link" href="##">{{ __('messages.employer_menu.company_logs') }}</a>
                    </li>
                </ul>
            </li>
           <!-- <li class="nav-item {{ Request::is('employer/jobs*') ? 'active' : ''}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="##">
                    <i class="fa fa-cog"></i><span>{{ __('messages.employer_menu.services') }}</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="##">
                    <i class="fab fa-foursquare"></i>
                    <span>{{ __('messages.employer_menu.candidates') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="##">
                    <i class="fas fa-shopping-cart"></i>
                    <span>{{ __('messages.employer_menu.cart') }}</span>
                </a>
            </li>
            ...
            <li class="nav-item {{ Request::is('employer/activity-log') ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('employer.activity-log') }}">
                    <i class="fas fa-list"></i>
                    <span>{{ __('messages.employer_menu.activity_log') }}</span>
                </a>
            </li>
        </ul>
    </div>
