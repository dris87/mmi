...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-12">
            <div class="form-group">
                <label class="custom-switch pl-0">
                    <span class="pr-3">Eltérő levelezési cím megadása</span>
                    <input type="checkbox" name="diff_mailing_address" class="custom-switch-input"
                           value="1" id="diffMailingAddress" @if($company->diff_mailing_address) checked="checked" @endif>
                    <span class="custom-switch-indicator"></span>
                </label>
            </div>
        </div>
        <div  id="mailingAddressWrapper" class="@if(!isset($company->diff_mailing_address)) mailing-wrapper-hidden @endif form-group col-12 px-0 mx-0 mb-0 row">
...
<div class="row">
    <div class="form-group col-xl-12 col-md-12 col-sm-12">
        {{ Form::label('why_work_with_us', __('messages.company.why_work_with_us_full').'?') }}<span class="text-danger">*</span>
