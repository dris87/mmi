            ...
            <li class="nav-item">
                <a href="{{ route('front.search.jobs') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('web.jobs') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('candidate/relevant_jobs') ? 'active' : ''}}">
                <a href="{{ route('get_relevant_jobs') }}"
                   class="nav-link {{ Request::is('candidate/relevant_jobs') ? 'active' : ''}}">
                    <i class="fas fa-tachometer-alt"></i>
                    <span>{{ __('messages.candidate.relevant_jobs') }} </span></a>
            </li>
            <li class="nav-item {{ Request::is('candidate/profile') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    <i class="fas fa-id-card-alt"></i>
                    <span>{{ __('messages.candidate.my_profile') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('candidate/resumes') ? 'active' : ''}}">
                <a href="{{ route('candidate.my_resumes') }}"
                   class="nav-link {{ Request::is('candidate/resumes') ? 'active' : ''}}">
                    <i class="far fa-file"></i>
                    <span>{{ __('messages.candidate.my_resume') }} </span></a>
