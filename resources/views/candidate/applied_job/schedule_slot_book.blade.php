        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-right mt-4 action-buttons">
                    {{ Form::button(__('messages.job_stage.send_slots'), ['type'=>'submit','class' => 'btn btn-primary','id'=>'scheduleInterviewBtnSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.processing')]) }}
