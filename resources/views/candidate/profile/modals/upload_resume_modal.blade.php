            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        {{ Form::label('resumelanguageLabel', __('messages.cv.language').':') }}
                        <div class="input-group">
                            {{Form::select('resumeLanguage',$data['language'], null, ['class' => 'form-control','id'=>'resumelanguage','multiple'=>false,'required'])}}
                        </div>
                    </div>
                    <div class="form-group col-sm-6 mb-0 pt-1">
                        <label>{{ __('messages.cv.current') }}</label>
