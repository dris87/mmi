...
{{--                                class="text-danger">*</span>--}}
{{--                        {{ Form::select('country_id', $data['countries'], null, ['id'=>'educationCountryId','class' => 'form-control','placeholder' => 'Válasszon országot', 'data-modal-type' => 'education']) }}--}}
{{--                    </div>--}}
{{--                    <div class="form-group col-sm-6">--}}
...
{{--                    </div>--}}
                    ...
                    <div class="form-group col-sm-6">
                        {{ Form::label('year_to', __('messages.candidate_profile.year_to').':') }}<span
                            class="text-danger">*</span>
                        {{ Form::selectYear('year_to', date('Y'), 1980, null, ['class' => 'form-control','placeholder'=>'Jelenleg is tart']) }}
                    </div>
                </div>
                <div class="text-right">
                    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary','id'=>'btnEducationSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.processing')]) }}
