...
<div class="row">
    ...
    <div class="form-group col-sm-6">
        {{ Form::label('country', __('messages.company.country').':') }}<span
                class="text-danger">*</span>
        {{ Form::select('country_id', $data['countries'], null, ['id'=>'editCountry','class' => 'form-control','placeholder' => 'Válasszon országot', 'data-modal-type' => 'experience', 'data-is-edit' => 'true']) }}
    </div>
    <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::select('city_id', [], null, ['id'=>'editCity','class' => 'form-control','placeholder' => 'Válasszon települést', 'data-is-edit' => 'true']) }}
    </div>
    <div class="form-group col-sm-6">
...
<div class="text-right">
    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary mb-2','id'=>'btnEditExperienceSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.processing')]) }}
