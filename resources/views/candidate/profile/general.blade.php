            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    {{ Form::label('phone', __('messages.candidate.phone').':', []) }}<span
                        class="text-danger">*</span>
                    {{ Form::number('phone', isset($user->phone) ? $user->phone : null, ['id'=>'phone','class' => 'form-control']) }}
            ...
            <div class="row mt-4">
                ...
                <div class="form-group col-sm-6 text-right pull-right">
                    <a style="color:red" href="javascript:void(0)"
                       id="delete-profile">Profil törlése</a>
                </div>
...
<script>
    ...
    let deleteProfilUrl = "{{ route('delete-profile') }}";
    let isEdit = true;
...
@push('page-scripts')
    ...
    <script src="{{asset('assets/js/candidate-profile/candidate-general.js?v=3.0.5')}}"></script>
