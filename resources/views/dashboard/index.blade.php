                            ...
                            <table class="table table-striped mb-0">
                                ...
                                @forelse($data['registerCandidatesData'] as $registeredCandidates)
                                    <tr>
                                        <td>
                                            <a href="#"
{{--                                                href="{{ route('candidates.show', $registeredCandidates->id) }}"--}}
                                ...
                                @forelse($data['registerEmployersData'] as $registeredEmployers)
                                    <tr>
                                        <td>
                                            <a
                                                href="#"
                                            >{{ $registeredEmployers->user->full_name }}</a>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                @forelse($data['recentJobsData'] as $recentJobs)
                                    <tr>
                                        <td>
                                            <a href="#"
{{--                                               href="{{ route('admin.jobs.show', $recentJobs->id) }}"--}}
                                            >{{ $recentJobs->job_title }}</a>
                                        </td>
                                        <td>
                                            <a href="#"
{{--                                                href="{{ route('company.show', $recentJobs->company_id) }}"--}}
                                            >{{ $recentJobs->company->user->full_name }}</a>
                                        </td>
