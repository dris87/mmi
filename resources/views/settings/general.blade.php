...
@section('section')
    ...
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="w-auto pl-3 mt-1">
                    <img id='logoPreview' class="img-thumbnail thumbnail-preview"
                         src="{{($setting['logo']) ? asset($setting['logo']) : asset('assets/img/main-logo.png')}}">
                </div>
            </div>
        </div>
        <div class="form-group col-sm-4">
            <div class="row">
                <div class="px-3">
                    {{ Form::label('app_footer_logo','Lábléc Logo:') }}<span class="text-danger">*</span>
                    <i class="fas fa-question-circle ml-1 mt-1 general-question-mark" data-toggle="tooltip"
                       data-placement="top" title="Upload 90 x 60 logo to get best user experience."></i>
                    <label class="image__file-upload"> {{ __('messages.setting.choose') }}
                ...
                <div class="w-auto pl-3 mt-1">
                    <img id='footerLogoPreview' class="img-thumbnail thumbnail-preview"
                         src="{{($setting['footer_logo']) ? asset($setting['footer_logo']) : asset('assets/img/main-logo.png')}}">
                </div>
            </div>
        </div>
        <div class="form-group col-sm-4">
            <div class="row">
                ...
                <div class="w-auto pl-3 mt-1">
                    <img id='faviconPreview' class="img-thumbnail thumbnail-preview mt-4 width-40px"
                         src="{{($setting['favicon']) ? asset($setting['favicon']) : asset('assets/img/main-logo.png')}}">
                </div>
            </div>
        </div>
        <div class="form-group col-lg-12 col-md-12 d-flex justify-content-start">
            ...
            <span
                class="custom-switch-description font-weight-bold ">{{ __('messages.setting.enable_google_recaptcha') }}</span>
        </div>
    </div>
    <div class="row mt-4">
        <!-- Submit Field -->
