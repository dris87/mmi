 ...
 * BaseFactory
 */
class JobAssignedCategoryFactory extends BaseFactory
{
    ...
    {
        $this->model = JobAssignedCategory::class;
    }
    ...
    public function createOrUpdate(Job $objJob, array $arrData): bool
    {
        ...
        foreach ($arrData as $key => $item){
            ...
            $obj = new JobAssignedCategory();
            $obj->setJobId($objJob->getId());
            $obj->setJobCategoryId($item['job_category_id']);
