...
class UpdateEmployerRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            //Mailing Address
            'diff_mailing_address' => 'sometimes',
            'mailing_zipCode' => 'nullable|required_with:diff_mailing_address,on|numeric|exists:postal_codes,postal_code',
            'mailing_city'    => 'nullable|required_with:diff_mailing_address,on|exists:cities,name',
            'mailing_houseNumber'    => 'nullable|required_with:diff_mailing_address',
            'mailing_street'    => 'nullable|required_with:diff_mailing_address',
