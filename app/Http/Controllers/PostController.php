...
use App\Queries\PostCommentsDataTable;
...
class PostController extends AppBaseController
{
    ...
    {
        if ($request->ajax()) {
            return Datatables::of((new PostCommentsDataTable())->getComments())->make(true);
        }
    ...
    public function showComment(int $id): JsonResponse
    {
        ...
        return $this->sendResponse($postComment, 'Post Comments Retrieved Successfully.');
    }
}
