...
Route::get('/', static fn () => view('web.home.home'))->name('web.home');
...
Route::get('pricing', static fn () => view('pricing.index'));
...
Route::group(['middleware' => ['auth', 'role:Admin', 'xss', 'verified.user', 'permission'], 'prefix' => 'admin'], static function (): void {
    ...
    Route::get('/coworkers/company/{company_id}', [CoworkerController::class, 'getCoworkerData'])->name('admin.company.coworkers');
    ...
    Route::get('/event-log', [EventLogController::class, 'index'])->name('admin.event-log');
    Route::get('/event-log/candidate/{candidate_id}', [EventLogController::class, 'getCandidateData'])->name('admin.candidate.event-log');
    Route::get('/event-log/company/{company_id}', [EventLogController::class, 'getCompanyData'])->name('admin.company.event-log');
...
Route::group(['middleware' => ['auth', 'role:Admin|Employer|Candidate', 'xss', 'verified.user', 'permission']], static function (): void {
...
Route::group(['middleware' => ['auth', 'role:Employer', 'xss', 'verified.user'], 'prefix' => 'cegfiok'], static function (): void {
    // TODO:: need to change this
    Route::get('/ceg', static fn () => view('employer.layouts.app'));

    Route::get('/', [DashboardController::class, 'employerDashboard'])->name('employer.dashboard');
    Route::get('activity-log', [EventLogController::class, 'getCompanyActivityView'])->name('employer.activity-log');
    Route::get('activity-log-data', [EventLogController::class, 'getCompanyData'])->name('employer.activity-log-data');
    Route::get(
...
Route::group(['namespace' => 'Web', 'middleware' => ['xss', 'setLanguage']], static function (): void {
    ...
    Route::get('/candidate-profile', static fn () => view('web.profile.candidate_profile'))->name('front.candidate.profile');
    ...
    Route::get('/contact-us', static fn () => view('web.contact.index'))->name('front.contact');
...
Route::group(['middleware' => ['xss', 'verified.user']], static function (): void {
    Route::get(
        'candidate-details/{uniqueId}',
        [Web\CandidateController::class, 'getCandidateDetails']
    )->name('front.candidate.details');
...
Route::group(['middleware' => ['auth', 'role:Candidate', 'xss', 'verified.user'], 'prefix' => 'candidate'], static function (): void {
    // Read notification
    Route::post(
        '/notification/{notification}/read',
        [NotificationController::class, 'readNotification']
    )->name('read-notification3');
...
// upgrade to v4.2.0
Route::get('/upgrade-to-v4-2-0', static function (): void {
    Artisan::call('db:seed', ['--class' => 'AddIsFullSliderSettingSeeder']);
    Artisan::call('db:seed', ['--class' => 'AddIsSliderActiveDeactiveSeeder']);
    Artisan::call('db:seed', ['--class' => 'RenameIsActiveToSlierIsActiveInSettingSeeder']);
    Artisan::call('db:seed', ['--class' => 'AddRecordNotificationSetting']);
    Artisan::call('db:seed', ['--class' => 'UpdateNotificationSettingAdminTypeSeeder']);
});

// upgrade to v4.4.0
Route::get('/upgrade-to-v4-4-0', static function (): void {
    Artisan::call('db:seed', ['--class' => 'AddEnableGoogleRecaptchaSeeder']);
});

// upgrade to v4.5.0
Route::get('/upgrade-to-v4-5-0', static function (): void {
    Artisan::call(
        'db:seed',
...
// upgrade to v6.0.0
Route::get('/upgrade-to-v6-0-0', static function (): void {
    Artisan::call(
        'db:seed',
...
// upgrade to v6.1.0
Route::get('/upgrade-to-v6-1-0', static function (): void {
    Artisan::call(
        'db:seed',
...
// upgrade to v7.1.0
Route::get('/upgrade-to-v7-1-0', static function (): void {
    Artisan::call(
        'db:seed',
...
// upgrade to v7.1.1
Route::get('/upgrade-to-v7-1-1', static function (): void {
    Artisan::call(
        'db:seed',
...
// upgrade to v8.0.0
Route::get('/upgrade-to-v8-0-0', static function (): void {
    Artisan::call(
        'migrate',
        [
            '--force' => true,
...
// upgrade to v8.1.0
Route::get('/upgrade-to-v8-1-0', static function (): void {
    Artisan::call(
        'migrate',
        [
            '--force' => true,
...
// upgrade to v9.0.0
Route::get('/upgrade-to-v9-0-0', static function (): void {
    Artisan::call('db:seed',
