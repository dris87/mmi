...
$(document).ready(function(){
        ...
        columns: [
...

            {
                ...
                data: function data(row) {
                    ...
                    return prepareTemplateRender('#candidateCVActionTemplate', data);
                },
                export: false
            }
        ]
    ...
    initialiseDatatable($(tableName), cvListUrl, config, Lang.get('messages.candidates_table.filename'));
